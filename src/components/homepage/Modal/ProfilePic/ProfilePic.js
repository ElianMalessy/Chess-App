...
export default function ProfilePic({ tempProfilePic, children, setTempProfilePic, possible, setPossible }) {
  ...
  useEffect(
    () => {
      ...
      if (state.image !== tempProfilePic && possible === true) setState({ ...state, image: tempProfilePic });
    },
